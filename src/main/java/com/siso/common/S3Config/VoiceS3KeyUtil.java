...
/**
 * 음성 샘플 S3 키 관리 유틸리티 클래스
 * 
 * 음성 샘플 S3 객체 키 생성 및 관리 기능을 제공합니다.
 */
@Component
public class VoiceS3KeyUtil {

    private static final String PREFIX = "voices/"; // S3 폴더 prefix

    /**
     * UUID 기반 고유 음성 파일명 생성
     * 
     * @param originalName 원본 파일명
     * @return UUID + 원본 파일명
     */
    public String generateUuidName(String originalName) {
        String safe = Optional.ofNullable(originalName).orElse("voice").replaceAll("[^a-zA-Z0-9._-]", "_");
